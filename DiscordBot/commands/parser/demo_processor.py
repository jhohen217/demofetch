    ...
    try:
        ...
        try:
            ...
            for csv_file in output_files:
                ...
                tick_base_dir = os.path.join(parser_output_dir, 'TickByTick') if parser_output_dir else ''
                
                if tick_base_dir:
                    os.makedirs(tick_base_dir, exist_ok=True) # Ensure base TickByTick directory exists
                    # Get month from the CSV file
                    month_dir_name = os.path.basename(os.path.dirname(csv_file)) # e.g., March from .../KillCollections/March/file.csv
                    tick_month_dir = os.path.join(tick_base_dir, month_dir_name)
                    ...
                    logger.warning("ParserOutput directory not found in config, cannot create TickByTick directories.")
