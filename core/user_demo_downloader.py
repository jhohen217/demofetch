...
class DemoDownloader:
    ...
    def download_demo(self, match_id, username):
        ...
        demos_dir = os.path.join("userdemos", username)
        ...
        try:
            ...
            temp_dir = os.path.join("userdemos", "_temp", match_id)
...
def download_user_demos(username, num_demos):
    ...
    try:
        # Check if matches file exists in usermatches directory
        matches_file = os.path.join("usermatches", f"{username}.txt")
